classdef Filter < dagnn.Layer
  ...
  methods
    ...
    function outputSizes = getOutputSizes(obj, inputSizes)
      ...
      outputSizes{1} = [...
        floor((inputSizes{1}(1) + obj.pad(1) + obj.pad(2) - ke(1)) / obj.stride(1)) + 1, ...
        floor((inputSizes{1}(2) + obj.pad(3) + obj.pad(4) - ke(2)) / obj.stride(2)) + 1, ...
        1, ...
        inputSizes{1}(4)] ;
    end
    ...
    function rfs = getReceptiveFields(obj)
      ...
      rfs.offset = [y1+y2, x1+x2]/2 ; %(ks(1)+1)/2 -pad(1)
    end
  end
end
